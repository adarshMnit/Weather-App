...
#0e3966867902783e6c2f99dafc3a974c
...
def format_response(weather):
    try:
         ...
         final_str='city:{0}\nCondition:{1}\nTemperature:{2}'.format(city,condition,temp)
    except:
        final_str='There was a problem in retriving information'    
    return final_str  

def get_weather(city):
    weather_key='0e3966867902783e6c2f99dafc3a974c'
...
def open_image(icon_name):
    ...
    img=ImageTk.PhotoImage(Image.open('./image/'+icon_name+'.png').resize(size,size))
